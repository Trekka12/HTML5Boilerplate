...
Hade en hel del <b style="color: #fff;">svårigheter och problem i början</b> med att sätta mig in i och förstå hur det var tänkt att man skulle arbeta med Git / GitHub, efter många om och men, rådfrågningar i IRC-chatten och genomläsning av Git-manualer och dbwebb-tutorials så tror jag äntligen jag kommit in i det hyfsat. Dock ej så säker på att jag kommit in i det såpass så jag arbetar på det optimalaste viset, men förstår iaf. någorlunda vad jag gör nu, vilket jag inte hade någon som helst aning om i början.<br><br>
...
<b style="color: #fff;">Ett litet irritationsmoment</b> jag stött på dock nu efter att ha intensivt arbetat med Git/GitHub och repo-kollaboration mellan olika servrar i några timmar i sträck, är den ökade utvecklingstiden samt den försvårade/fördröjda förhandsgranskningen av PHP-kods ändringarna - detta då jag först gör en ändring lokalt, sedan måste jag uppdatera GitHub repot och sedan pulla ned uppdateringarna från GitHub repot till studentservern för att få se ändringar/uppdateringarna.<br><br>

<b style="color: #fff;">Dock noterar jag även fördelarna</b> med detta system vid utvecklingsanvändning, då det dels backupar ens arbete regelbundet, man kan på ett lätt sätt koordinera mellan diverse servrar / arbetsstationer, smart med integration med vanliga shell-scripts, m.m.<br>
...
<b style="color: #fff;">Mina personliga åsikter om HTML5 Boilerplate</b> konceptet är väl att det är en smart tanke som jag själv faktiskt funderat en hel del på under mina utvecklingsdagar genom de senaste åren - dock kan jag tycka att det finns en generaliserad överdrift av funktioner - trots att jag kan förstå anledningen bakom allting - hade kanske varit smartare med ett grafiskt webb-gränssnitt som Modernizr-generatorn har isf. där man kan välja vad man önskar inkludera i sin HTML5 Boilerplate och därefter få en .zip genererad med nödvändigt och utvalt material -> Tänker man använda meta taggar? Isf. vilka? Ska man ha jQuery? Ska mallen vara responsiv?, osv.<br><br>
